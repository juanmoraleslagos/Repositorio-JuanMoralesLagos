...
export default class DetailOrderComponents extends Component {
    constructor(props) {
        super(props)
        this.state = {
            user_name: '',
    ...
    handleSubmit() {
        ...
        var body = JSON.stringify({ "username_detailorder": this.state.user_name, "code_document": 1, "code_datetime": 23})
