...
export default class DetailOrder_V5Components extends Component {
    constructor(props) {
        super(props)
        this.state = {
            user_name: '',
    ...
    render() {
        let myNotarias = this.state.notariasValues.map((myValue, myIndex) => {
            return (
                <Picker.Item label={myValue.domicile_notaria} value={myIndex} key={myIndex}
                />
            );
        })
        ...
        return (
            <View style={stylesDetailOrder.containerDetailOrder}>
                ...
                <Text style={stylesDetailOrder.textDetailOrder}>
                    DOCUMENTO : Poder Alterar Características de Vehículos
                </Text>
